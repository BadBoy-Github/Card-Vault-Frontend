          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-[var(--color-text-muted)]">
                  Your gift card will be delivered to your registered email with
                  a Gift Card ID, PIN number, and expiry date.
                </p>
              </div>
            </div>
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-sm text-[var(--color-text-muted)]">
                  Go to the official {card.brand} website or app where you want
