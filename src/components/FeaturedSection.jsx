...
const features = [
  ...
  },
  {
    id: 'genuine',
    title: 'Genuine',
    description: 'Only official, verified gift cards.',
    icon: (
      <svg className="h-8 w-8 sm:h-9 sm:w-9" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    id: 'trust',
    title: 'Trust',
    description: 'Secure payments and instant delivery.',
    icon: (
      <svg className="h-8 w-8 sm:h-9 sm:w-9" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Codes sent to you right away.',
    icon: (
      <svg className="h-8 w-8 sm:h-9 sm:w-9" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function FeaturedSection() {
  return (
    <section className="section-padding-lg px-4 sm:px-6 md:px-8" aria-labelledby="featured-heading">
      <div className="mx-auto max-w-[980px]">
        <div className="mb-8 text-center sm:mb-12">
          ...
          <p className="apple-body mx-auto mt-2 max-w-[600px] px-2 text-[15px] sm:mt-3 sm:text-[17px] md:text-[19px]">
            We make buying gift cards simple, safe, and fast.
          </p>
          <Link
            to="/#gift-cards"
