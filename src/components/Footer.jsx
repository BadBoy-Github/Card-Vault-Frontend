...
import { HiMail, HiPhone, HiOutlineGlobe } from "react-icons/hi";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-[12px] text-[var(--color-text-muted)] mt-1">
              Your destination for digital gift cards
            </p>
          </div>

          {/* Quick Links */}
          <nav className="flex flex-wrap justify-center items-center gap-4 text-[14px]">
            <Link
              to="/"
